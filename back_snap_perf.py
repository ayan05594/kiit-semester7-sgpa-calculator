...
class ScheduleFileParser:
    def __init__(self, schedule_file, filter_suite=None, filter_tags=None, filter_flag=None):
    ...
    def _apply_filtering(self):
        """Apply multi-step filtering: first by suite, then by tags/flags"""
        ...
        # Step 2: Filter by tags or flags
        if self.filter_tags:
            ...
            self.filtered_sections = suite_filtered_sections[:]
...
note:
  ...
  Long version/compiler strings are automatically truncated to prevent database warnings.
    ...
    def load_schedule_file(self):
        ...
        self.schedule_parser = ScheduleFileParser(self.args.ta, filter_suite, filter_tags, filter_flag)
